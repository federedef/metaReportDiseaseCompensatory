<%
    ...
    edge_density_heatmap = prh.parse_heatmap_from_flat(plotter.hash_vars['embeddings_nonInt_stats'][1:],
        1,2,6,{22:"Gene coverage"},{23:"Metric",24:"separator",25:"Dataset"},1)
    # zampieri
    ...
    zampieri_cov_heatmap = prh.parse_heatmap_from_flat(plotter.hash_vars["zampieri_nonInt_coverage"][1:],1,2,3,None,{4:"Metric",5:"separator",6:"Dataset"},1/zampieri_positives)
    # buphamalai
    ...
    buphamalai_cov_heatmap = prh.parse_heatmap_from_flat(plotter.hash_vars["buphamalai_nonInt_coverage"][1:],
        1,2,3,None,{4:"Metric",5:"separator",6:"Dataset"}, 1/buphamalai_positives)
    # compensation
    ...
    compensation_cov_heatmap = prh.parse_heatmap_from_flat(plotter.hash_vars["compensation_nonInt_coverage"][1:],
        1,2,3,None,{4:"Metric",5:"separator",6:"Dataset"}, 1/compensation_positives)
